...
// Инициация подписания через MobileID
$url = "https://dsig.eesti.ee/siga/hashcodecontainers/$containerId/mobiilidsigning";
$data = [
    'type' => 'mobiilid',
...
$url = "https://dsig.eesti.ee/siga/hashcodecontainers/$containerId/mobiilidsigning/$signatureId/status";
